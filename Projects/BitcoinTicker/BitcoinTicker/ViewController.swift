...
class ViewController: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        ...
        self.getBitcoinPrice(url: finalURL, currencyIndex: row)
    }
    
    //MARK: - Networking
    /***************************************************************/
    
    func getBitcoinPrice(url: String, currencyIndex: Int) {
        ...
        Alamofire.request(url, method: .get)
            .responseJSON { response in
                if response.result.isSuccess {
                    ...
                    self.updateBitcoinPrice(json: bitcoinPriceJSON, currencyIndex: currencyIndex)
    ...
    func updateBitcoinPrice(json : JSON, currencyIndex: Int) {
        if let bitcoinResult = json["last"].double {
            bitcoinPriceLabel.text = currencySymbolArray[currencyIndex] + String(bitcoinResult)
        } else {
